...
// Defines values for KYCInfoVerificationStatus.
const (
	KYCInfoVerificationStatusCompleted  KYCInfoVerificationStatus = "completed"
	KYCInfoVerificationStatusInProgress KYCInfoVerificationStatus = "in_progress"
	KYCInfoVerificationStatusPending    KYCInfoVerificationStatus = "pending"
	KYCInfoVerificationStatusRejected   KYCInfoVerificationStatus = "rejected"
)

// Defines values for OffRampPayoutType.
const (
	Iban OffRampPayoutType = "iban"
)
...
// Defines values for PayinTypeOptionType.
const (
	Paya  PayinTypeOptionType = "paya"
	Pol   PayinTypeOptionType = "pol"
	Satna PayinTypeOptionType = "satna"
)
...
// Defines values for RampAccountResponseStatus.
const (
	RampAccountResponseStatusKYCCompleted  RampAccountResponseStatus = "KYCCompleted"
	RampAccountResponseStatusKYCInProgress RampAccountResponseStatus = "KYCInProgress"
	RampAccountResponseStatusKYCRejected   RampAccountResponseStatus = "KYCRejected"
	RampAccountResponseStatusPending       RampAccountResponseStatus = "Pending"
)
...
// AuthTokenCreationRequest defines model for AuthTokenCreationRequest.
type AuthTokenCreationRequest struct {
...
// AuthTokenCreationResponse defines model for AuthTokenCreationResponse.
type AuthTokenCreationResponse struct {
	// ExpiresAt The expiration time of the auth token
...
// CollectUniswapV3RewardsByIncentiveTxRequest defines model for CollectUniswapV3RewardsByIncentiveTxRequest.
type CollectUniswapV3RewardsByIncentiveTxRequest struct {
	Incentive UniswapV3StakerIncentiveKeyRequest `json:"incentive"`
...
// KYCInfo KYC information fetched from KYC service
type KYCInfo struct {
	Sessions           *[]KYCSession              `json:"sessions,omitempty"`
	VerificationStatus *KYCInfoVerificationStatus `json:"verificationStatus,omitempty"`
}

// KYCInfoVerificationStatus defines model for KYCInfo.VerificationStatus.
type KYCInfoVerificationStatus string

// KYCSession defines model for KYCSession.
type KYCSession struct {
	...
	Submissions  *[]KYCSubmission `json:"submissions,omitempty"`
...
type KYCSubmission struct {
	...
	MachineVerified *bool      `json:"machineVerified,omitempty"`
}
...
// OffRampPayout defines model for OffRampPayout.
type OffRampPayout struct {
	...
	// Type Type of payout method
	Type OffRampPayoutType `json:"type"`
}

// OffRampPayoutType Type of payout method
type OffRampPayoutType string
...
// PayinTypeOption defines model for PayinTypeOption.
type PayinTypeOption struct {
	BankName string `json:"bankName"`

	// Eta ETA in minutes/hours
	Eta string `json:"eta"`
	...
	Type            PayinTypeOptionType `json:"type"`
}

// PayinTypeOptionType defines model for PayinTypeOption.Type.
type PayinTypeOptionType string
...
type PositionDetails struct {
	...
	// NumberOfStakes number of incenvtives that this token is staked on
	...
	// Staked Whether the position is staked or not
...
// RampAccountBankAccount defines model for RampAccountBankAccount.
type RampAccountBankAccount struct {
	BankName    *string   `json:"bankName"`
...
// RampAccountBankRequest defines model for RampAccountBankRequest.
type RampAccountBankRequest struct {
	// CardOrIban Card number or IBAN number
	CardOrIban string `json:"cardOrIban"`
}

// RampAccountBankResponse defines model for RampAccountBankResponse.
type RampAccountBankResponse struct {
	// BankAccountId Bank account ID
	BankAccountId int64  `json:"bankAccountId"`
	Status        string `json:"status"`
}

// RampAccountCreationRequest defines model for RampAccountCreationRequest.
type RampAccountCreationRequest struct {
	// BirthDate Birth date in Persian format (YYYY/MM/DD)
...
// RampAccountCreationResponse defines model for RampAccountCreationResponse.
type RampAccountCreationResponse struct {
	Address  string  `json:"address"`
	KycLink  *string `json:"kycLink"`
	KycToken *string `json:"kycToken"`
	Status   string  `json:"status"`
}

// RampAccountResponse defines model for RampAccountResponse.
type RampAccountResponse struct {
	Address string `json:"address"`

	// BankAccounts List of bank accounts associated with this ramp account
	BankAccounts *[]RampAccountBankAccount `json:"bankAccounts,omitempty"`
	CreatedAt    time.Time                 `json:"createdAt"`

	// KycInfo KYC information fetched from KYC service
	KycInfo *KYCInfo `json:"kycInfo,omitempty"`

	// KycLink Latest KYC link for in-progress KYC
	KycLink *string `json:"kycLink"`

	// KycVerified Whether KYC is verified
	KycVerified *bool                     `json:"kycVerified,omitempty"`
	Status      RampAccountResponseStatus `json:"status"`
	UpdatedAt   time.Time                 `json:"updatedAt"`
}

// RampAccountResponseStatus defines model for RampAccountResponse.Status.
type RampAccountResponseStatus string

// RampOffRampTxRequest defines model for RampOffRampTxRequest.
type RampOffRampTxRequest struct {
	// Amount The amount in ZAR (human-readable)
	Amount string        `json:"amount"`
	Payout OffRampPayout `json:"payout"`
}

// RampOffRampTxResponse defines model for RampOffRampTxResponse.
type RampOffRampTxResponse struct {
	ChainActivity ChainActivity `json:"chainActivity"`

	// Key The on-chain ramp key (available after the transaction is submitted)
	Key *string `json:"key,omitempty"`

	// OffchainRef The off-chain reference ID for this ramp
	OffchainRef string `json:"offchainRef"`
}

// RampOnRampRequest defines model for RampOnRampRequest.
type RampOnRampRequest struct {
	// Address User Ethereum address
	Address *string `json:"address,omitempty"`

	// Amount Amount in TMN (toman)
	Amount string `json:"amount"`

	// BankAccountId Registered bank account ID
	BankAccountId int64 `json:"bankAccountId"`
}

// RampOnRampResponse defines model for RampOnRampResponse.
type RampOnRampResponse struct {
	BankName   string            `json:"bankName"`
	Iban       string            `json:"iban"`
	OwnerName  string            `json:"ownerName"`
	PayinTypes []PayinTypeOption `json:"payinTypes"`
}
...
type SessionMessageResponse struct {
	// Message Message to be signed for session creation
	Message string `json:"message"`

	// Timestamp Timestamp included in the message
...
type SessionRequest struct {
	...
	// Signature Hex-encoded signature of the session message
	Signature string `json:"signature"`

	// Timestamp Timestamp from the session message
	Timestamp int64 `json:"timestamp"`
}
...
// StablecoinSystemExitGemTxRequest defines model for StablecoinSystemExitGemTxRequest.
type StablecoinSystemExitGemTxRequest struct {
	// Amount The amount of Gem token or ETH to exit from the Vat contract.
	Amount *string `json:"amount,omitempty"`

	// User Ethereum address of the user who intends to exit Gem tokens or ETH from the Vat contract and receive them.
	User string `json:"user"`

	// VaultId The ID of the vault associated with the urn holding the Gem token or ETH.
	VaultId int `json:"vaultId"`
}
...
// StakedPositionWithReward defines model for StakedPositionWithReward.
type StakedPositionWithReward struct {
	// TokenId token id
	TokenId         string        `json:"tokenId"`
	UnclaimedReward AccruedReward `json:"unclaimedReward"`
}

// StakedPositionsList defines model for StakedPositionsList.
type StakedPositionsList struct {
	// IncentiveId 32-byte incentive ID, encoded as a hexadecimal string
	IncentiveId string                     `json:"incentiveId"`
	Positions   []StakedPositionWithReward `json:"positions"`
}
...
type Token struct {
	...
	// DescriptionFa The Persian description of the token.
	DescriptionFa *string `json:"descriptionFa,omitempty"`
	...
	// NameFa The Persian name of the token.
	NameFa *string `json:"nameFa,omitempty"`

	// PersianName The Persian name of the token.
	PersianName string `json:"persianName"`

	// Price The price of the token in multiple currencies
	Price *Currency `json:"price"`
...
// UniswapV3StakeByIncentiveTxRequest defines model for UniswapV3StakeByIncentiveTxRequest.
type UniswapV3StakeByIncentiveTxRequest struct {
	Incentive UniswapV3StakerIncentiveKeyRequest `json:"incentive"`
...
// UniswapV3UnstakeByIncentiveTxRequest defines model for UniswapV3UnstakeByIncentiveTxRequest.
type UniswapV3UnstakeByIncentiveTxRequest struct {
	// CollectReward Whether to collect reward or not
	CollectReward *bool                              `json:"collectReward,omitempty"`
	Incentive     UniswapV3StakerIncentiveKeyRequest `json:"incentive"`
	TokenIds      *[]string                          `json:"tokenIds,omitempty"`
...
// UserStakedPositionsByIncentiveIdResponse defines model for UserStakedPositionsByIncentiveIdResponse.
type UserStakedPositionsByIncentiveIdResponse = []StakedPositionsList
...
type Vault struct {
	...
	// Liquidated Indicates if the vault has been liquidated.
	...
	Owner        string   `json:"owner"`
	TokenBalance Currency `json:"tokenBalance"`
...
type WalletResponse struct {
	Address  string    `json:"address"`
	Balances []Balance `json:"balances"`
	Cash     Currency  `json:"cash"`
	Crypto   Currency  `json:"crypto"`
	Network  Network   `json:"network"`
}

// WalletTransferTxRequest defines model for WalletTransferTxRequest.
type WalletTransferTxRequest struct {
	// Amount The amount of the transfer in native token units. If not provided, it will be calculated based on the wallet balance.
	Amount *string `json:"amount,omitempty"`

	// From Ethereum address of the sender
	From string `json:"from"`

	// To Ethereum address of the recipient
	To string `json:"to"`
...
// WalletTransferTxResponse defines model for WalletTransferTxResponse.
type WalletTransferTxResponse struct {
	ChainActivity *ChainActivity `json:"chainActivity,omitempty"`
}
...
// GetSessionMessageParams defines parameters for GetSessionMessage.
type GetSessionMessageParams struct {
	// Address User Ethereum address
...
// GetStakedPositionsByIncentiveIdParams defines parameters for GetStakedPositionsByIncentiveId.
type GetStakedPositionsByIncentiveIdParams struct {
	// User Ethereum address of the user
	User string `form:"user" json:"user"`

	// IncentiveId incentive id
	IncentiveId *string `form:"incentiveId,omitempty" json:"incentiveId,omitempty"`
}

// GetAvailablePositionsToStakeParams defines parameters for GetAvailablePositionsToStake.
type GetAvailablePositionsToStakeParams struct {
	// User Ethereum address of the user
	User string `form:"user" json:"user"`

	// IncentiveId incentive id
	IncentiveId string `form:"incentiveId" json:"incentiveId"`
}
...
type CreateAuthTokenJSONRequestBody = AuthTokenCreationRequest
...
// CreateRampAccountJSONRequestBody defines body for CreateRampAccount for application/json ContentType.
type CreateRampAccountJSONRequestBody = RampAccountCreationRequest

// AddBankAccountJSONRequestBody defines body for AddBankAccount for application/json ContentType.
type AddBankAccountJSONRequestBody = RampAccountBankRequest

// CreateSessionJSONRequestBody defines body for CreateSession for application/json ContentType.
type CreateSessionJSONRequestBody = SessionRequest

// CreateOffRampJSONRequestBody defines body for CreateOffRamp for application/json ContentType.
type CreateOffRampJSONRequestBody = RampOffRampTxRequest

// CreateOnRampJSONRequestBody defines body for CreateOnRamp for application/json ContentType.
type CreateOnRampJSONRequestBody = RampOnRampRequest
...
type ExitGemTransactionJSONRequestBody = StablecoinSystemExitGemTxRequest
...
// CollectUniswapV3RewardsFromIncentiveJSONRequestBody defines body for CollectUniswapV3RewardsFromIncentive for application/json ContentType.
type CollectUniswapV3RewardsFromIncentiveJSONRequestBody = CollectUniswapV3RewardsByIncentiveTxRequest
...
// StakeUniswapV3PositionsInIncentiveJSONRequestBody defines body for StakeUniswapV3PositionsInIncentive for application/json ContentType.
type StakeUniswapV3PositionsInIncentiveJSONRequestBody = UniswapV3StakeByIncentiveTxRequest
...
// UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody defines body for UnstakeUniswapV3PositionsFromIncentive for application/json ContentType.
type UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody = UniswapV3UnstakeByIncentiveTxRequest

// WalletTransferJSONRequestBody defines body for WalletTransfer for application/json ContentType.
type WalletTransferJSONRequestBody = WalletTransferTxRequest
...
type ClientInterface interface {
	...
	// CreateRampAccountWithBody request with any body
	CreateRampAccountWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateRampAccount(ctx context.Context, body CreateRampAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AddBankAccountWithBody request with any body
	AddBankAccountWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AddBankAccount(ctx context.Context, body AddBankAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetMyRampAccount request
	GetMyRampAccount(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetRampAccount request
	GetRampAccount(ctx context.Context, id int64, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	GetSessionMessage(ctx context.Context, params *GetSessionMessageParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateOffRampWithBody request with any body
	CreateOffRampWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateOffRamp(ctx context.Context, body CreateOffRampJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateOnRampWithBody request with any body
	CreateOnRampWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateOnRamp(ctx context.Context, body CreateOnRampJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// GetStakedPositionsByIncentiveId request
	GetStakedPositionsByIncentiveId(ctx context.Context, params *GetStakedPositionsByIncentiveIdParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetAvailablePositionsToStake request
	GetAvailablePositionsToStake(ctx context.Context, params *GetAvailablePositionsToStakeParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// CollectUniswapV3RewardsFromIncentiveWithBody request with any body
	CollectUniswapV3RewardsFromIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CollectUniswapV3RewardsFromIncentive(ctx context.Context, body CollectUniswapV3RewardsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// StakeUniswapV3PositionsInIncentiveWithBody request with any body
	StakeUniswapV3PositionsInIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StakeUniswapV3PositionsInIncentive(ctx context.Context, body StakeUniswapV3PositionsInIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// UnstakeUniswapV3PositionsFromIncentiveWithBody request with any body
	UnstakeUniswapV3PositionsFromIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UnstakeUniswapV3PositionsFromIncentive(ctx context.Context, body UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// WalletTransferWithBody request with any body
	...
	WalletTransfer(ctx context.Context, body WalletTransferJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetWalletByAddress request
	GetWalletByAddress(ctx context.Context, address string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateRampAccountWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateRampAccountRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateRampAccount(ctx context.Context, body CreateRampAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateRampAccountRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddBankAccountWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddBankAccountRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddBankAccount(ctx context.Context, body AddBankAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddBankAccountRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetMyRampAccount(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetMyRampAccountRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetRampAccount(ctx context.Context, id int64, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetRampAccountRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetSessionMessage(ctx context.Context, params *GetSessionMessageParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSessionMessageRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateOffRampWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateOffRampRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateOffRamp(ctx context.Context, body CreateOffRampJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateOffRampRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateOnRampWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateOnRampRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateOnRamp(ctx context.Context, body CreateOnRampJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateOnRampRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetStakedPositionsByIncentiveId(ctx context.Context, params *GetStakedPositionsByIncentiveIdParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetStakedPositionsByIncentiveIdRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetAvailablePositionsToStake(ctx context.Context, params *GetAvailablePositionsToStakeParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetAvailablePositionsToStakeRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CollectUniswapV3RewardsFromIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCollectUniswapV3RewardsFromIncentiveRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CollectUniswapV3RewardsFromIncentive(ctx context.Context, body CollectUniswapV3RewardsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCollectUniswapV3RewardsFromIncentiveRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StakeUniswapV3PositionsInIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStakeUniswapV3PositionsInIncentiveRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StakeUniswapV3PositionsInIncentive(ctx context.Context, body StakeUniswapV3PositionsInIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStakeUniswapV3PositionsInIncentiveRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UnstakeUniswapV3PositionsFromIncentiveWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUnstakeUniswapV3PositionsFromIncentiveRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UnstakeUniswapV3PositionsFromIncentive(ctx context.Context, body UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUnstakeUniswapV3PositionsFromIncentiveRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) WalletTransfer(ctx context.Context, body WalletTransferJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewWalletTransferRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetWalletByAddress(ctx context.Context, address string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetWalletByAddressRequest(c.Server, address)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewCreateRampAccountRequest calls the generic CreateRampAccount builder with application/json body
func NewCreateRampAccountRequest(server string, body CreateRampAccountJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateRampAccountRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateRampAccountRequestWithBody generates requests for CreateRampAccount with any type of body
func NewCreateRampAccountRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/accounts")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewAddBankAccountRequest calls the generic AddBankAccount builder with application/json body
func NewAddBankAccountRequest(server string, body AddBankAccountJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAddBankAccountRequestWithBody(server, "application/json", bodyReader)
}

// NewAddBankAccountRequestWithBody generates requests for AddBankAccount with any type of body
func NewAddBankAccountRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/accounts/bank")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetMyRampAccountRequest generates requests for GetMyRampAccount
func NewGetMyRampAccountRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/accounts/me")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetRampAccountRequest generates requests for GetRampAccount
func NewGetRampAccountRequest(server string, id int64) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/accounts/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewCreateSessionRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v2/ramp/session")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetSessionMessageRequest generates requests for GetSessionMessage
func NewGetSessionMessageRequest(server string, params *GetSessionMessageParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/session/message")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewCreateOffRampRequest calls the generic CreateOffRamp builder with application/json body
func NewCreateOffRampRequest(server string, body CreateOffRampJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateOffRampRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateOffRampRequestWithBody generates requests for CreateOffRamp with any type of body
func NewCreateOffRampRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/tx/offramp")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewCreateOnRampRequest(server string, body CreateOnRampJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateOnRampRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateOnRampRequestWithBody generates requests for CreateOnRamp with any type of body
func NewCreateOnRampRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/ramp/tx/onramp")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewExitGemTransactionRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v2/stablecoinsystem/tx/exitgem")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetStakedPositionsByIncentiveIdRequest generates requests for GetStakedPositionsByIncentiveId
func NewGetStakedPositionsByIncentiveIdRequest(server string, params *GetStakedPositionsByIncentiveIdParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/uniswap/staking/activestakes")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.IncentiveId != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "incentiveId", runtime.ParamLocationQuery, *params.IncentiveId); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewGetAvailablePositionsToStakeRequest generates requests for GetAvailablePositionsToStake
func NewGetAvailablePositionsToStakeRequest(server string, params *GetAvailablePositionsToStakeParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/uniswap/staking/availabletostake")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewCollectUniswapV3RewardsFromIncentiveRequest calls the generic CollectUniswapV3RewardsFromIncentive builder with application/json body
func NewCollectUniswapV3RewardsFromIncentiveRequest(server string, body CollectUniswapV3RewardsFromIncentiveJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCollectUniswapV3RewardsFromIncentiveRequestWithBody(server, "application/json", bodyReader)
}

// NewCollectUniswapV3RewardsFromIncentiveRequestWithBody generates requests for CollectUniswapV3RewardsFromIncentive with any type of body
func NewCollectUniswapV3RewardsFromIncentiveRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/uniswap/tx/collectincentiverewards")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewStakeUniswapV3PositionsInIncentiveRequest calls the generic StakeUniswapV3PositionsInIncentive builder with application/json body
func NewStakeUniswapV3PositionsInIncentiveRequest(server string, body StakeUniswapV3PositionsInIncentiveJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStakeUniswapV3PositionsInIncentiveRequestWithBody(server, "application/json", bodyReader)
}

// NewStakeUniswapV3PositionsInIncentiveRequestWithBody generates requests for StakeUniswapV3PositionsInIncentive with any type of body
func NewStakeUniswapV3PositionsInIncentiveRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/uniswap/tx/stakeincentive")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewUnstakeUniswapV3PositionsFromIncentiveRequest calls the generic UnstakeUniswapV3PositionsFromIncentive builder with application/json body
func NewUnstakeUniswapV3PositionsFromIncentiveRequest(server string, body UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUnstakeUniswapV3PositionsFromIncentiveRequestWithBody(server, "application/json", bodyReader)
}

// NewUnstakeUniswapV3PositionsFromIncentiveRequestWithBody generates requests for UnstakeUniswapV3PositionsFromIncentive with any type of body
func NewUnstakeUniswapV3PositionsFromIncentiveRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/uniswap/tx/unstakeincentive")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewWalletTransferRequest calls the generic WalletTransfer builder with application/json body
func NewWalletTransferRequest(server string, body WalletTransferJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewWalletTransferRequestWithBody(server, "application/json", bodyReader)
}
...
func NewWalletTransferRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v2/wallet/tx/transfer")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetWalletByAddressRequest generates requests for GetWalletByAddress
func NewGetWalletByAddressRequest(server string, address string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/wallet/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// CreateRampAccountWithBodyWithResponse request with any body
	CreateRampAccountWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateRampAccountResponse, error)

	CreateRampAccountWithResponse(ctx context.Context, body CreateRampAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateRampAccountResponse, error)

	// AddBankAccountWithBodyWithResponse request with any body
	AddBankAccountWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddBankAccountResponse, error)

	AddBankAccountWithResponse(ctx context.Context, body AddBankAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*AddBankAccountResponse, error)

	// GetMyRampAccountWithResponse request
	GetMyRampAccountWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetMyRampAccountResponse, error)

	// GetRampAccountWithResponse request
	GetRampAccountWithResponse(ctx context.Context, id int64, reqEditors ...RequestEditorFn) (*GetRampAccountResponse, error)
	...
	// GetSessionMessageWithResponse request
	GetSessionMessageWithResponse(ctx context.Context, params *GetSessionMessageParams, reqEditors ...RequestEditorFn) (*GetSessionMessageResponse, error)

	// CreateOffRampWithBodyWithResponse request with any body
	CreateOffRampWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOffRampResponse, error)

	CreateOffRampWithResponse(ctx context.Context, body CreateOffRampJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOffRampResponse, error)

	// CreateOnRampWithBodyWithResponse request with any body
	CreateOnRampWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOnRampResponse, error)

	CreateOnRampWithResponse(ctx context.Context, body CreateOnRampJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOnRampResponse, error)
	...
	// GetStakedPositionsByIncentiveIdWithResponse request
	GetStakedPositionsByIncentiveIdWithResponse(ctx context.Context, params *GetStakedPositionsByIncentiveIdParams, reqEditors ...RequestEditorFn) (*GetStakedPositionsByIncentiveIdResponse, error)

	// GetAvailablePositionsToStakeWithResponse request
	GetAvailablePositionsToStakeWithResponse(ctx context.Context, params *GetAvailablePositionsToStakeParams, reqEditors ...RequestEditorFn) (*GetAvailablePositionsToStakeResponse, error)
	...
	// CollectUniswapV3RewardsFromIncentiveWithBodyWithResponse request with any body
	CollectUniswapV3RewardsFromIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CollectUniswapV3RewardsFromIncentiveResponse, error)

	CollectUniswapV3RewardsFromIncentiveWithResponse(ctx context.Context, body CollectUniswapV3RewardsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*CollectUniswapV3RewardsFromIncentiveResponse, error)
	...
	// StakeUniswapV3PositionsInIncentiveWithBodyWithResponse request with any body
	StakeUniswapV3PositionsInIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StakeUniswapV3PositionsInIncentiveResponse, error)

	StakeUniswapV3PositionsInIncentiveWithResponse(ctx context.Context, body StakeUniswapV3PositionsInIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*StakeUniswapV3PositionsInIncentiveResponse, error)
	...
	// UnstakeUniswapV3PositionsFromIncentiveWithBodyWithResponse request with any body
	UnstakeUniswapV3PositionsFromIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UnstakeUniswapV3PositionsFromIncentiveResponse, error)

	UnstakeUniswapV3PositionsFromIncentiveWithResponse(ctx context.Context, body UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*UnstakeUniswapV3PositionsFromIncentiveResponse, error)
	...
	// WalletTransferWithBodyWithResponse request with any body
	...
	WalletTransferWithResponse(ctx context.Context, body WalletTransferJSONRequestBody, reqEditors ...RequestEditorFn) (*WalletTransferResponse, error)

	// GetWalletByAddressWithResponse request
	GetWalletByAddressWithResponse(ctx context.Context, address string, reqEditors ...RequestEditorFn) (*GetWalletByAddressResponse, error)
...
type CreateAuthTokenResponse struct {
	...
	JSON200      *AuthTokenCreationResponse
	JSON400      *UserError
	JSON500      *Error
}
...
type CreateRampAccountResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *RampAccountCreationResponse
	JSON400      *UserError
	JSON401      *Error
	JSON500      *Error
}
...
// Status returns HTTPResponse.Status
func (r CreateRampAccountResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateRampAccountResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type AddBankAccountResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *RampAccountBankResponse
	JSON400      *UserError
	JSON401      *Error
	JSON403      *Error
	JSON404      *Error
...
// Status returns HTTPResponse.Status
func (r AddBankAccountResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r AddBankAccountResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetMyRampAccountResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *RampAccountResponse
	JSON401      *Error
	JSON404      *Error
	JSON500      *Error
}
...
// Status returns HTTPResponse.Status
func (r GetMyRampAccountResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetMyRampAccountResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetRampAccountResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *RampAccountResponse
	JSON401      *Error
...
// Status returns HTTPResponse.Status
func (r GetRampAccountResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetRampAccountResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetSessionMessageResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r GetSessionMessageResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetSessionMessageResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r CreateOffRampResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateOffRampResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetStakedPositionsByIncentiveIdResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *UserStakedPositionsByIncentiveIdResponse
	JSON400      *Error
	JSON500      *Error
}

// Status returns HTTPResponse.Status
func (r GetStakedPositionsByIncentiveIdResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetStakedPositionsByIncentiveIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetAvailablePositionsToStakeResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *UserPositions
	JSON400      *Error
...
// Status returns HTTPResponse.Status
func (r GetAvailablePositionsToStakeResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetAvailablePositionsToStakeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CollectUniswapV3RewardsFromIncentiveResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ChainActivity
	JSON400      *UserError
...
// Status returns HTTPResponse.Status
func (r CollectUniswapV3RewardsFromIncentiveResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CollectUniswapV3RewardsFromIncentiveResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type StakeUniswapV3PositionsInIncentiveResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ChainActivity
	JSON400      *UserError
...
// Status returns HTTPResponse.Status
func (r StakeUniswapV3PositionsInIncentiveResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r StakeUniswapV3PositionsInIncentiveResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type UnstakeUniswapV3PositionsFromIncentiveResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ChainActivity
	JSON400      *UserError
...
// Status returns HTTPResponse.Status
func (r UnstakeUniswapV3PositionsFromIncentiveResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UnstakeUniswapV3PositionsFromIncentiveResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type WalletTransferResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *WalletTransferTxResponse
	JSON400      *Error
	JSON500      *Error
}
...
type GetWalletByAddressResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r GetWalletByAddressResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetWalletByAddressResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// CreateRampAccountWithBodyWithResponse request with arbitrary body returning *CreateRampAccountResponse
func (c *ClientWithResponses) CreateRampAccountWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateRampAccountResponse, error) {
	rsp, err := c.CreateRampAccountWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateRampAccountResponse(rsp)
}

func (c *ClientWithResponses) CreateRampAccountWithResponse(ctx context.Context, body CreateRampAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateRampAccountResponse, error) {
	rsp, err := c.CreateRampAccount(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateRampAccountResponse(rsp)
...
// AddBankAccountWithBodyWithResponse request with arbitrary body returning *AddBankAccountResponse
func (c *ClientWithResponses) AddBankAccountWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddBankAccountResponse, error) {
	rsp, err := c.AddBankAccountWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddBankAccountResponse(rsp)
}

func (c *ClientWithResponses) AddBankAccountWithResponse(ctx context.Context, body AddBankAccountJSONRequestBody, reqEditors ...RequestEditorFn) (*AddBankAccountResponse, error) {
	rsp, err := c.AddBankAccount(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddBankAccountResponse(rsp)
...
// GetMyRampAccountWithResponse request returning *GetMyRampAccountResponse
func (c *ClientWithResponses) GetMyRampAccountWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetMyRampAccountResponse, error) {
	rsp, err := c.GetMyRampAccount(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetMyRampAccountResponse(rsp)
}

// GetRampAccountWithResponse request returning *GetRampAccountResponse
func (c *ClientWithResponses) GetRampAccountWithResponse(ctx context.Context, id int64, reqEditors ...RequestEditorFn) (*GetRampAccountResponse, error) {
	rsp, err := c.GetRampAccount(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetRampAccountResponse(rsp)
}
...
// GetSessionMessageWithResponse request returning *GetSessionMessageResponse
func (c *ClientWithResponses) GetSessionMessageWithResponse(ctx context.Context, params *GetSessionMessageParams, reqEditors ...RequestEditorFn) (*GetSessionMessageResponse, error) {
	rsp, err := c.GetSessionMessage(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetSessionMessageResponse(rsp)
}

// CreateOffRampWithBodyWithResponse request with arbitrary body returning *CreateOffRampResponse
func (c *ClientWithResponses) CreateOffRampWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOffRampResponse, error) {
	rsp, err := c.CreateOffRampWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateOffRampResponse(rsp)
}

func (c *ClientWithResponses) CreateOffRampWithResponse(ctx context.Context, body CreateOffRampJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOffRampResponse, error) {
	rsp, err := c.CreateOffRamp(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateOffRampResponse(rsp)
...
func (c *ClientWithResponses) CreateOnRampWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOnRampResponse, error) {
	rsp, err := c.CreateOnRampWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateOnRampWithResponse(ctx context.Context, body CreateOnRampJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOnRampResponse, error) {
	rsp, err := c.CreateOnRamp(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateOnRampResponse(rsp)
...
// GetStakedPositionsByIncentiveIdWithResponse request returning *GetStakedPositionsByIncentiveIdResponse
func (c *ClientWithResponses) GetStakedPositionsByIncentiveIdWithResponse(ctx context.Context, params *GetStakedPositionsByIncentiveIdParams, reqEditors ...RequestEditorFn) (*GetStakedPositionsByIncentiveIdResponse, error) {
	rsp, err := c.GetStakedPositionsByIncentiveId(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetStakedPositionsByIncentiveIdResponse(rsp)
}

// GetAvailablePositionsToStakeWithResponse request returning *GetAvailablePositionsToStakeResponse
func (c *ClientWithResponses) GetAvailablePositionsToStakeWithResponse(ctx context.Context, params *GetAvailablePositionsToStakeParams, reqEditors ...RequestEditorFn) (*GetAvailablePositionsToStakeResponse, error) {
	rsp, err := c.GetAvailablePositionsToStake(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetAvailablePositionsToStakeResponse(rsp)
}
...
// CollectUniswapV3RewardsFromIncentiveWithBodyWithResponse request with arbitrary body returning *CollectUniswapV3RewardsFromIncentiveResponse
func (c *ClientWithResponses) CollectUniswapV3RewardsFromIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CollectUniswapV3RewardsFromIncentiveResponse, error) {
	rsp, err := c.CollectUniswapV3RewardsFromIncentiveWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCollectUniswapV3RewardsFromIncentiveResponse(rsp)
}

func (c *ClientWithResponses) CollectUniswapV3RewardsFromIncentiveWithResponse(ctx context.Context, body CollectUniswapV3RewardsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*CollectUniswapV3RewardsFromIncentiveResponse, error) {
	rsp, err := c.CollectUniswapV3RewardsFromIncentive(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCollectUniswapV3RewardsFromIncentiveResponse(rsp)
...
// StakeUniswapV3PositionsInIncentiveWithBodyWithResponse request with arbitrary body returning *StakeUniswapV3PositionsInIncentiveResponse
func (c *ClientWithResponses) StakeUniswapV3PositionsInIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StakeUniswapV3PositionsInIncentiveResponse, error) {
	rsp, err := c.StakeUniswapV3PositionsInIncentiveWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStakeUniswapV3PositionsInIncentiveResponse(rsp)
}

func (c *ClientWithResponses) StakeUniswapV3PositionsInIncentiveWithResponse(ctx context.Context, body StakeUniswapV3PositionsInIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*StakeUniswapV3PositionsInIncentiveResponse, error) {
	rsp, err := c.StakeUniswapV3PositionsInIncentive(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStakeUniswapV3PositionsInIncentiveResponse(rsp)
...
// UnstakeUniswapV3PositionsFromIncentiveWithBodyWithResponse request with arbitrary body returning *UnstakeUniswapV3PositionsFromIncentiveResponse
func (c *ClientWithResponses) UnstakeUniswapV3PositionsFromIncentiveWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UnstakeUniswapV3PositionsFromIncentiveResponse, error) {
	rsp, err := c.UnstakeUniswapV3PositionsFromIncentiveWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUnstakeUniswapV3PositionsFromIncentiveResponse(rsp)
}

func (c *ClientWithResponses) UnstakeUniswapV3PositionsFromIncentiveWithResponse(ctx context.Context, body UnstakeUniswapV3PositionsFromIncentiveJSONRequestBody, reqEditors ...RequestEditorFn) (*UnstakeUniswapV3PositionsFromIncentiveResponse, error) {
	rsp, err := c.UnstakeUniswapV3PositionsFromIncentive(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUnstakeUniswapV3PositionsFromIncentiveResponse(rsp)
...
func (c *ClientWithResponses) WalletTransferWithResponse(ctx context.Context, body WalletTransferJSONRequestBody, reqEditors ...RequestEditorFn) (*WalletTransferResponse, error) {
	rsp, err := c.WalletTransfer(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseWalletTransferResponse(rsp)
...
// GetWalletByAddressWithResponse request returning *GetWalletByAddressResponse
func (c *ClientWithResponses) GetWalletByAddressWithResponse(ctx context.Context, address string, reqEditors ...RequestEditorFn) (*GetWalletByAddressResponse, error) {
	rsp, err := c.GetWalletByAddress(ctx, address, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetWalletByAddressResponse(rsp)
}
...
func ParseCreateAuthTokenResponse(rsp *http.Response) (*CreateAuthTokenResponse, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest AuthTokenCreationResponse
...
// ParseCreateRampAccountResponse parses an HTTP response from a CreateRampAccountWithResponse call
func ParseCreateRampAccountResponse(rsp *http.Response) (*CreateRampAccountResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateRampAccountResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest RampAccountCreationResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseAddBankAccountResponse parses an HTTP response from a AddBankAccountWithResponse call
func ParseAddBankAccountResponse(rsp *http.Response) (*AddBankAccountResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest RampAccountBankResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseGetMyRampAccountResponse parses an HTTP response from a GetMyRampAccountWithResponse call
func ParseGetMyRampAccountResponse(rsp *http.Response) (*GetMyRampAccountResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetMyRampAccountResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetRampAccountResponse parses an HTTP response from a GetRampAccountWithResponse call
func ParseGetRampAccountResponse(rsp *http.Response) (*GetRampAccountResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetRampAccountResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetSessionMessageResponse parses an HTTP response from a GetSessionMessageWithResponse call
func ParseGetSessionMessageResponse(rsp *http.Response) (*GetSessionMessageResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetSessionMessageResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseCreateOffRampResponse parses an HTTP response from a CreateOffRampWithResponse call
func ParseCreateOffRampResponse(rsp *http.Response) (*CreateOffRampResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateOffRampResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest RampOffRampTxResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseGetStakedPositionsByIncentiveIdResponse parses an HTTP response from a GetStakedPositionsByIncentiveIdWithResponse call
func ParseGetStakedPositionsByIncentiveIdResponse(rsp *http.Response) (*GetStakedPositionsByIncentiveIdResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetStakedPositionsByIncentiveIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest UserStakedPositionsByIncentiveIdResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseGetAvailablePositionsToStakeResponse parses an HTTP response from a GetAvailablePositionsToStakeWithResponse call
func ParseGetAvailablePositionsToStakeResponse(rsp *http.Response) (*GetAvailablePositionsToStakeResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetAvailablePositionsToStakeResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseCollectUniswapV3RewardsFromIncentiveResponse parses an HTTP response from a CollectUniswapV3RewardsFromIncentiveWithResponse call
func ParseCollectUniswapV3RewardsFromIncentiveResponse(rsp *http.Response) (*CollectUniswapV3RewardsFromIncentiveResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CollectUniswapV3RewardsFromIncentiveResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseStakeUniswapV3PositionsInIncentiveResponse parses an HTTP response from a StakeUniswapV3PositionsInIncentiveWithResponse call
func ParseStakeUniswapV3PositionsInIncentiveResponse(rsp *http.Response) (*StakeUniswapV3PositionsInIncentiveResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &StakeUniswapV3PositionsInIncentiveResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUnstakeUniswapV3PositionsFromIncentiveResponse parses an HTTP response from a UnstakeUniswapV3PositionsFromIncentiveWithResponse call
func ParseUnstakeUniswapV3PositionsFromIncentiveResponse(rsp *http.Response) (*UnstakeUniswapV3PositionsFromIncentiveResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UnstakeUniswapV3PositionsFromIncentiveResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParseWalletTransferResponse(rsp *http.Response) (*WalletTransferResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest WalletTransferTxResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseGetWalletByAddressResponse parses an HTTP response from a GetWalletByAddressWithResponse call
func ParseGetWalletByAddressResponse(rsp *http.Response) (*GetWalletByAddressResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetWalletByAddressResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
